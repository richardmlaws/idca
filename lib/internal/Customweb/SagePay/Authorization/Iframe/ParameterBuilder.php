...
class Customweb_SagePay_Authorization_Iframe_ParameterBuilder extends Customweb_SagePay_Authorization_AbstractParameterBuilder
{
	...
	public function buildParameters() {
		...
		$parameters = array_merge(
			...
			$paymentMethod->getSpecialIframeParameters(
					$this->getTransaction(),
					$this->getFormData(),
					$this->container
				)
