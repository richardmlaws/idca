...
namespace Customweb\SagePayCw\Block\Checkout;
...
class AbstractCheckout extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @return \Customweb\SagePayCw\Block\Checkout\AbstractCheckout
	 */
	...
	/**
	 * @param \Customweb\SagePayCw\Model\Authorization\Method\AbstractMethod $adapter
	 * @return \Customweb\SagePayCw\Block\Checkout\AbstractCheckout
	 */
	public function setAuthorizationAdapter(\Customweb\SagePayCw\Model\Authorization\Method\AbstractMethod $adapter)
	{
	...
	{
		if (!($this->authorizationAdapter instanceof \Customweb\SagePayCw\Model\Authorization\Method\AbstractMethod)) {
