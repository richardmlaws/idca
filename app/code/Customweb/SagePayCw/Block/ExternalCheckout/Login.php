...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_SagePayCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('sagepaycw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('sagepaycw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('sagepaycw/externalCheckout/registerPost', ['_secure' => true]);
	}
