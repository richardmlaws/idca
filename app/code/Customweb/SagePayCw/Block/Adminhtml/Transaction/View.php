...
namespace Customweb\SagePayCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('sagepaycw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('sagepaycw_transaction');
	}
	...
	{
		return $this->getUrl('sagepaycw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('sagepaycw/transaction/');
	}
}