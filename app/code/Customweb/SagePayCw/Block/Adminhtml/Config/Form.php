...
namespace Customweb\SagePayCw\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_SagePayCw::sagepaycw/config/form.phtml';

	/**
	 * @var \Customweb\SagePayCw\Model\Config\Structure
	 */
	protected $_formStructure;

	/**
	 * @var \Customweb\SagePayCw\Model\Renderer\Adminhtml\BackendForm
	 */
	protected $_backendFormRenderer;

	/**
	 * @param \Magento\Backend\Block\Template\Context $context
	 * @param \Customweb\SagePayCw\Model\Config\Structure $formStructure,
	 * @param \Customweb\SagePayCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\SagePayCw\Model\Config\Structure $formStructure,
			\Customweb\SagePayCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer,
			array $data = []
	) {
