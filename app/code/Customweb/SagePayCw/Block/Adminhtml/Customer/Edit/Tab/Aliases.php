...
namespace Customweb\SagePayCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\SagePayCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\SagePayCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\SagePayCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('sagepaycw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('sagepaycw/customer/aliases', ['_current' => true]);
    }
