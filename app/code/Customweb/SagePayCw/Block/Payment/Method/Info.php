...
class Info extends \Magento\Payment\Block\Info
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_SagePayCw::payment/method/info.phtml';
	...
	{
		return $this->getUrl('sagepaycw/transaction/view', ['transaction_id' => $this->getTransaction()->getId()]);
	}
