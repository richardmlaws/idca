...
namespace Customweb\SagePayCw\Block\Payment\Method;
...
class Form extends \Magento\Payment\Block\Form
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_SagePayCw::payment/method/form.phtml';
	...
	public function getPaymentForm()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_SagePayCw_License::run('ci0908kj89tnisde', $this, $arguments);
	}

	final public function call_3fhs4gs5fbb7hrgi() {
	...
	private function getFormRenderer() {
		return new \Customweb\SagePayCw\Model\Renderer\CheckoutForm($this->getMethodCode());
	}
