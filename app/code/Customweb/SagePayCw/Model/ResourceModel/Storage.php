...
namespace Customweb\SagePayCw\Model\ResourceModel;
...
class Storage extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_sagepaycw_storage_resource';
    ...
    {
        $this->_init('customweb_sagepaycw_storage', 'key_id');
    }
