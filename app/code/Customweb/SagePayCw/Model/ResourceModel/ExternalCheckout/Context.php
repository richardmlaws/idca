...
namespace Customweb\SagePayCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\SagePayCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_sagepaycw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_sagepaycw_external_checkout_context', 'context_id');
    }
