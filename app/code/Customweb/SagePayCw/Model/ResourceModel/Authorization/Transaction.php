...
namespace Customweb\SagePayCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\SagePayCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_sagepaycw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\SagePayCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_sagepaycw_transaction', 'entity_id');
    }
