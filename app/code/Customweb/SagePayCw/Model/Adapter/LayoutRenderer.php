...
namespace Customweb\SagePayCw\Model\Adapter;
...
class LayoutRenderer extends \Customweb_Mvc_Layout_Renderer
{
	...
	{
		$this->_view->loadLayout(['default', 'sagepaycw_layout_renderer'], true, true, false);
		...
		$this->_view->getPage()->getConfig()->addPageAsset('Customweb_SagePayCw::css/sagepaycw.css');
	}
	...
	{
		$this->_view->getLayout()->addBlock('\Magento\Framework\View\Element\Text', 'sagepaycw.main.content', 'content')->setText($content);
	}
