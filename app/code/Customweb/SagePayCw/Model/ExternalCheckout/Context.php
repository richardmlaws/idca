...
namespace Customweb\SagePayCw\Model\ExternalCheckout;

/**
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\SagePayCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_sagepaycw_external_checkout_context';
	...
	/**
	 * @var \Customweb\SagePayCw\Model\Payment\Method\AbstractMethod
	 */
	...
	public function __construct(
			...
			\Customweb\SagePayCw\Helper\InvoiceItem $invoiceItemHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\SagePayCw\Model\ResourceModel\ExternalCheckout\Context');
    }
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\SagePayCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\SagePayCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\SagePayCw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\SagePayCw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\SagePayCw\Model\Payment\Method\AbstractMethod) {
			$data = [
