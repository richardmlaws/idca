...
class Service implements \Customweb_Payment_ExternalCheckout_ICheckoutService
{
	...
	/**
	 * @var \Customweb\SagePayCw\Helper\ExternalCheckout
	 */
	protected $_helper;
	...
	/**
	 * @var \Customweb\SagePayCw\Model\Authorization\OrderContextFactory
	 */
	 ...
	 * @param \Customweb\SagePayCw\Helper\ExternalCheckout $helper
	...
	public function __construct(
			...
			\Customweb\SagePayCw\Helper\ExternalCheckout $helper,
	...
	/**
	 * @param \Customweb\SagePayCw\Model\DependencyContainer $container
	 * @return \Customweb\SagePayCw\Model\ExternalCheckout\Service
	 */
	public function setContainer(\Customweb\SagePayCw\Model\DependencyContainer $container)
	{
	...
	{
		if (!($context instanceof \Customweb\SagePayCw\Model\ExternalCheckout\Context)) {
			throw new \Customweb_Core_Exception_CastException('Customweb\SagePayCw\Model\ExternalCheckout\Context');
		}
	...
	public function authenticate(\Customweb_Payment_ExternalCheckout_IContext $context, $emailAddress, $successUrl)
	{
		...
		if ($this->_checkoutHelper->isAllowedGuestCheckout($context->getQuote())
				&& $this->_scopeConfig->getValue('sagepaycw/shop/external_checkout_account_creation') == 'skip_selection') {
			...
			$context->setRegisterMethod(\Customweb\SagePayCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
		...
		$context->save();
		return \Customweb_Core_Http_Response::redirect($context->getQuote()->getStore()->getUrl('sagepaycw/externalCheckout/login', ['_secure' => true]));
	}
	...
	public function renderShippingMethodSelectionPane(\Customweb_Payment_ExternalCheckout_IContext $context, $errorMessages)
	{
		...
		return $this->_layoutFactory->create()->createBlock('Customweb\SagePayCw\Block\ExternalCheckout\ShippingMethods')
			->setContext($context)
	...
	public function renderReviewPane(\Customweb_Payment_ExternalCheckout_IContext $context, $renderConfirmationFormElements, $errorMessage)
	{
		...
		$layout->getUpdate()->load(['sagepaycw_externalcheckout_review']);
		$layout->generateXml();
		$layout->generateElements();
		$layout->getBlock('customweb_sagepaycw_externalcheckout_review')
			->setContext($context)
	...
	public function createOrder(\Customweb_Payment_ExternalCheckout_IContext $context)
	{
		...
		try {
			...
			$transaction = $this->_coreRegistry->registry('sagepaycw_transaction');
