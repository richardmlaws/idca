...
namespace Customweb\SagePayCw\Model\Renderer\Adminhtml;

class CheckoutForm extends \Customweb\SagePayCw\Model\Renderer\AbstractForm
{
	/**
	...
	public function __construct(
		...
		$this->setControlCssClassResolver(new \Customweb\SagePayCw\Model\Renderer\Adminhtml\ControlCssClassResolver());

		$this->setFormCssClass('sagepaycw_form');
