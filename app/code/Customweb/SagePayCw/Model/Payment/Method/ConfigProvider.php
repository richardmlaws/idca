...
class ConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
        ...
        public function getForm(AbstractMethod $method)
    {
		...
		return \Customweb_Licensing_SagePayCw_License::run('k86lba8bur8cpf7j', $this, $arguments);
	}

	final public function call_4f17hcdlaorkuqlg() {
    ...
    protected function getFailureMessage(AbstractMethod $method)
    {
    	if ($this->_checkoutSession->getQuote()->getPayment()->getMethod() == $method->getCode()) {
	    	$failureMessage = $this->_checkoutSession->getSagePayCwFailureMessage();
	    	if (!empty($failureMessage)) {
	    		$this->_checkoutSession->unsSagePayCwFailureMessage();
    ...
    protected function getImageUrl(AbstractMethod $method)
    {
    	try {
    		...
    		return $this->_assetRepo->getUrlWithParams('Customweb_SagePayCw/images/payment/method/' . $method->getPaymentMethodName() . '.png', $params);
    ...
    {
    	return new \Customweb\SagePayCw\Model\Renderer\CheckoutForm($method->getCode());
    }
