 ...
 * @method \Customweb\SagePayCw\Model\Storage setKeySpace(string $value)
 * @method string getKeyName()
 * @method \Customweb\SagePayCw\Model\Storage setKeyName(string $value)
 * @method string getKeyValue()
 * @method \Customweb\SagePayCw\Model\Storage setKeyValue(string $value)
 */
class Storage extends \Magento\Framework\Model\AbstractModel
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_sagepaycw_storage';
    ...
    {
        $this->_init('Customweb\SagePayCw\Model\ResourceModel\Storage');
    }
