...
class TransactionHandler implements \Customweb_Payment_ITransactionHandler
{
	 ...
	 * @param mixed $value
	 * @param string $field
	 * @return null|\Customweb\SagePayCw\Model\Authorization\Transaction
	 */
	 ...
	 */
	private function storeInCache(\Customweb\SagePayCw\Model\Authorization\Transaction $transaction)
	{
