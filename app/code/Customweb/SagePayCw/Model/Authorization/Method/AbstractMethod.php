...
namespace Customweb\SagePayCw\Model\Authorization\Method;
...
abstract class AbstractMethod
{
	...
	/**
	 * @var \Customweb\SagePayCw\Model\Authorization\TransactionContextFactory
	 */
	...
	/**
	 * @var \Customweb\SagePayCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory
	 */
	protected $_transactionCollectionFactory;

	/**
	 * @var \Customweb\SagePayCw\Model\Authorization\Method\Context\Factory
	 */
	...
	/**
	 * @var \Customweb\SagePayCw\Model\Authorization\Method\Context\IContext
	 */
	private $context;
	 ...
	 * @param \Customweb\SagePayCw\Model\Authorization\TransactionContextFactory $transactionContextFactory
	 * @param \Customweb\SagePayCw\Model\Authorization\TransactionFactory $transactionFactory
	 * @param \Customweb\SagePayCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory
	 * @param \Customweb\SagePayCw\Model\Authorization\Method\Context\Factory $contextFactory
	 * @param \Customweb\SagePayCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function __construct(
			...
			\Customweb\SagePayCw\Model\Authorization\TransactionContextFactory $transactionContextFactory,
			\Customweb\SagePayCw\Model\Authorization\TransactionFactory $transactionFactory,
			\Customweb\SagePayCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory,
			\Customweb\SagePayCw\Model\Authorization\Method\Context\Factory $contextFactory,
			\Customweb\SagePayCw\Model\Authorization\Method\Context\IContext $context
	...
	/**
	 * @return \Customweb\SagePayCw\Model\Authorization\Method\Context\IContext
	 */
	public function getContext()
	{
		if (!($this->context instanceof \Customweb\SagePayCw\Model\Authorization\Method\Context\IContext)) {
	 ...
	 * @param \Customweb\SagePayCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function setContext(\Customweb\SagePayCw\Model\Authorization\Method\Context\IContext $context)
	{
		$this->context = $context;
	}
	...
	public function initializeTransaction(\Customweb\SagePayCw\Model\Authorization\Transaction $transaction)
	{
		...
		$this->_checkoutSession->unsSagePayCwCheckoutId();
	...
	public function finishAuthorization()
	{
		if ($this->getContext()->getTransaction()->getTransactionObject()->isAuthorized()) {
			if ($this->getContext()->getPaymentMethod() instanceof \Customweb\SagePayCw\Model\Payment\Method\AbstractMethod) {
				$this->_coreRegistry->register('sagepaycw_authorization_transaction', $this->getContext()->getTransaction());
	...
	/**
	 * @return \Customweb\SagePayCw\Model\Authorization\Transaction|null
	 */
