...
class Factory
{
     ...
     */
    public function create(\Customweb\SagePayCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\SagePayCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\SagePayCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\SagePayCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\SagePayCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\SagePayCw\Model\Authorization\Method\Context\Factory
     */
