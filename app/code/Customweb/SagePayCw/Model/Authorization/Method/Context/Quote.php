...
class Quote extends AbstractContext
{
	...
	public function __construct(
			...
			\Customweb\SagePayCw\Model\Payment\Method\AbstractMethod $paymentMethod = null,
		...
		if (!($quote instanceof \Magento\Quote\Model\Quote)) {
			if ($this->_coreRegistry->registry('sagepaycwcheckout_moto')) {
	...
	{
		if (!($this->orderContext instanceof \Customweb\SagePayCw\Model\Authorization\OrderContext)) {
	...
	public function isMoto()
	{
		return $this->getQuote()->getIsSuperMode()
			|| $this->_coreRegistry->registry('sagepaycwcheckout_moto');
	}
}