 ...
 * @method \Customweb\SagePayCw\Model\Authorization\CustomerContext setContextId(string $value)
 * @method string getCustomerId()
 * @method \Customweb\SagePayCw\Model\Authorization\CustomerContext setCustomerId(string $value)
 * @method array getValues()
 * @method \Customweb\SagePayCw\Model\Authorization\CustomerContext setValues(array $value)
 * @method int getVersionNumber()
 * @method \Customweb\SagePayCw\Model\Authorization\CustomerContext setVersionNumber(int $value)
 */
class CustomerContext extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_Authorization_IPaymentCustomerContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_sagepaycw_customer_context';
	 ...
	 * @param \Customweb\SagePayCw\Model\Authorization\CustomerContextFactory $factory
	...
	public function __construct(
			...
			\Customweb\SagePayCw\Model\Authorization\CustomerContextFactory $factory,
    ...
    {
        $this->_init('Customweb\SagePayCw\Model\ResourceModel\Authorization\CustomerContext');
     ...
     * @return \Customweb\SagePayCw\Model\Authorization\CustomerContext
     */
