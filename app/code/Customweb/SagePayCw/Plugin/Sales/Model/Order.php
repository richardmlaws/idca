...
namespace Customweb\SagePayCw\Plugin\Sales\Model;
...
class Order
{
	...
	public function afterCanFetchPaymentReviewUpdate(\Magento\Sales\Model\Order $subject, $result)
	{
		...
		if ($subject->getPayment() instanceof \Magento\Sales\Model\Order\Payment
	    	&& $subject->getPayment()->getMethodInstance() instanceof \Customweb\SagePayCw\Model\Payment\Method\AbstractMethod
			&& $this->_coreRegistry->registry('sagepaycw_order_view')) {
