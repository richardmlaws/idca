...
namespace Customweb\SagePayCw\Controller;
...
abstract class Checkout extends \Magento\Framework\App\Action\Action
{
	 ...
	 */
	protected function handleSuccess(\Customweb\SagePayCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 */
	protected function handleFailure(\Customweb\SagePayCw\Model\Authorization\Transaction $transaction, $errorMessage)
	{
		$this->_checkoutSession->setLastRealOrderId($transaction->getOrder()->getRealOrderId());
		$this->restoreQuote();

		$this->messageManager->addError($errorMessage);
// 		$this->_checkoutSession->setSagePayCwFailureMessage($errorMessage);
