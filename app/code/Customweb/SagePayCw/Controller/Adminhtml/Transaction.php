...
namespace Customweb\SagePayCw\Controller\Adminhtml;
...
abstract class Transaction extends \Magento\Backend\App\Action
{
	...
	protected function _initAction()
	{
		...
		$resultPage->setActiveMenu('Customweb_SagePayCw::transactions');
		$resultPage->addBreadcrumb(__('Sales'), __('Sales'));
		$resultPage->addBreadcrumb('Sage Pay', 'Sage Pay');
		$resultPage->addBreadcrumb(__('Sage Pay Transactions'), __('Sage Pay Transactions'));
		return $resultPage;
	}
	 ...
	 *
	 * @return \Customweb\SagePayCw\Model\Authorization\Transaction|false
	 */
	protected function _initTransaction()
	{
		...
		$this->_coreRegistry->register('sagepaycw_transaction', $transaction);
		return $transaction;
	}

	protected function _isAllowed()
	{
		return $this->_authorization->isAllowed('Customweb_SagePayCw::transactions');
	}
}