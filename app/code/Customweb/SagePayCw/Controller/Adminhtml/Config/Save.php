...
namespace Customweb\SagePayCw\Controller\Adminhtml\Config;

class Save extends \Customweb\SagePayCw\Controller\Adminhtml\Config
{
	...
	private function storeConfigState()
	{
		...
		$storedConfigState = $storage->read(\Customweb\SagePayCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\SagePayCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY);
		...
		$storage->write(\Customweb\SagePayCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\SagePayCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY, $updatedConfigState);
	}
