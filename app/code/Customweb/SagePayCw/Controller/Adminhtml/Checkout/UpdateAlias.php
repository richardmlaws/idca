...
namespace Customweb\SagePayCw\Controller\Adminhtml\Checkout;

class UpdateAlias extends \Customweb\SagePayCw\Controller\Adminhtml\Checkout
{
	/**
	...
	public function __construct(
			...
			\Customweb\SagePayCw\Model\Payment\Method\ConfigProvider $configProvider
	) {
	...
	public function execute()
	{
		...
		/* @var $block \Customweb\SagePayCw\Block\Adminhtml\Checkout\Payment\Form */
		$block = $this->_layout->createBlock('Customweb\SagePayCw\Block\Adminhtml\Checkout\Payment\Form');
