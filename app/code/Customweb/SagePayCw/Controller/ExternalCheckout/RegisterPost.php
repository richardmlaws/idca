...
namespace Customweb\SagePayCw\Controller\ExternalCheckout;

class RegisterPost extends \Customweb\SagePayCw\Controller\ExternalCheckout
{
	/**
	...
	{
		if (!($this->getContext() instanceof \Customweb\SagePayCw\Model\ExternalCheckout\Context) || !$this->getContext()->getId()) {
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\SagePayCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER);
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\SagePayCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER))) {
