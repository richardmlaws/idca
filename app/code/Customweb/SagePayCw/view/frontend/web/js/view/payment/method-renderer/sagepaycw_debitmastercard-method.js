...
define(
    [
        ...
        'Customweb_SagePayCw/js/authorizationMethod',
        'Customweb_SagePayCw/js/storage',
        'Customweb_SagePayCw/js/alias',
    ...
    function ($, Component, mageTemplate, url, errorProcessor, Form, AuthorizationMethod, Storage, Alias, placeOrderAction, additionalValidators) {
        ...
        return Component.extend({
            defaults: {
                template: 'Customweb_SagePayCw/payment/sagepaycw_debitmastercard',
                fieldErrorTemplate: '<div for="<%- id %>" generated="true" class="mage-error" id="<%- id %>-error"><%- message %></div>',
                authorizationUrl: url.build('sagepaycw/checkout/authorize/'),
                updateAliasUrl: url.build('sagepaycw/checkout/updateAlias/'),
                updateVisibleFieldsUrl: url.build('sagepaycw/checkout/updateFields/')
            },
