...
namespace Customweb\SagePayCw\Helper;
...
class ExternalCheckout extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function validateCustomerData(\Magento\Quote\Model\Quote $quote, array $data, $registerMethod)
	{
		...
		if ($registerMethod == \Customweb\SagePayCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER) {
	 ...
	 */
	public function saveOrder(\Customweb\SagePayCw\Model\ExternalCheckout\Context $context)
	{
		$context->getQuote()->collectTotals()->save();

		$isNewCustomer = false;
		switch ($context->getRegisterMethod()) {
			case \Customweb\SagePayCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST:
				$this->prepareGuestQuote($context);
				break;
			case \Customweb\SagePayCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER:
	 ...
	 * @param \Customweb\SagePayCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareGuestQuote(\Customweb\SagePayCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\SagePayCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareNewCustomerQuote(\Customweb\SagePayCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\SagePayCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareCustomerQuote(\Customweb\SagePayCw\Model\ExternalCheckout\Context $context)
	{
		$billing = $context->getQuote()->getBillingAddress();
		$shipping = $context->getQuote()->isVirtual() ? null : $context->getQuote()->getShippingAddress();
	 ...
	 * @param \Customweb\SagePayCw\Model\ExternalCheckout\Context $context
	 */
	private function involveNewCustomer(\Customweb\SagePayCw\Model\ExternalCheckout\Context $context)
	{
		$customer = $context->getQuote()->getCustomer();
