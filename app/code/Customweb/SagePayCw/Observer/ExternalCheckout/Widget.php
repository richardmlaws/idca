...
namespace Customweb\SagePayCw\Observer\ExternalCheckout;
...
{
	/**
	 * @var \Customweb\SagePayCw\Model\ExternalCheckout\Widget\Collection
	 */
	protected $_widgetCollection;

	/**
	 * @param \Customweb\SagePayCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	 */
	public function __construct(
			\Customweb\SagePayCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	) {
