    ...
    public function getSectionData()
    {
        ...
        $return  = [
            ...
            'checkout.cart' => $this->getBlockHtml(
                'checkout.cart',
                ['default', 'checkout_cart_index', 'ajaxpro_checkout_cart_index']
            ),
            ...
            //              "jquery"
            //       ], function($) {
            //             var productViewModal = $("#ajaxpro-catalog\\\\.product\\\\.view").closest(".block-ajaxpro");
            //             if (productViewModal) {
            //                 try {
            //                     productViewModal.modal("closeModal");
            //                 } catch(err) {
            //                     console.error(err);
            //                 }
            //             }
