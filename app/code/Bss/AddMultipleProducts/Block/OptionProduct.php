    ...
    { 
            ...
            $blockOptionsHtml = null;
             ...
             {  
                ...
                // $_options = $blockOption->decorateArray($product->getOptions());
             ...
             {   
                ...
                // $blockViewType->setTemplate("Bss_AddMultipleProducts::catalog/product/links.phtml");
             ...
             {   
                ...
                $blockViewType = $this->getLayout()->createBlock("Magento\ConfigurableProduct\Block\Product\View\Type\Configurable");
                $blockViewType->setProduct($product); 
