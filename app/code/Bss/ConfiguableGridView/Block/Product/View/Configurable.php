...
class Configurable extends \Magento\Swatches\Block\Product\Renderer\Configurable
{
    ...
    public function getDetailHtml() {
        ...
        $html = '<div class="total-area"><div class="qty-detail"></div><div class="qty-total"><span class="label"><b>' . __('Total Qty:') . '</b></span><span class="value">0</span></div><div class="price-unit"><span class="label"><b>' . __('Unit:') . '</b></span><span class="value">' . $helper->getDisplayPriceWithCurrency(0) . '</span><span class="price-unit-excl"> (Excl. VAT: '. $helper->getDisplayPriceWithCurrency(0) .')</span></div><div class="price-total"><span class="label"><b>' . __('Total:') . '</b></span><span class="value">' . $helper->getDisplayPriceWithCurrency(0) . '</span><span class="price-total-excl"> (Excl. VAT: '. $helper->getDisplayPriceWithCurrency(0) .')</span></div></div>';
