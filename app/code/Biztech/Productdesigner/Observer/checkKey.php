...
class checkKey implements ObserverInterface {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        ...
        $s = '';
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, sprintf('https://www.brushyourideas.com/extension/licence.php'));
        ...
        //$enc = $this->encryptor;   
        if (empty($res)) {
            $this->_resourceConfig->saveConfig('productdesigner/activation/key', "");
            $this->_resourceConfig->saveConfig('productdesigner/productdesigner_general/enabled', 0);
