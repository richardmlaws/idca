...
class downloadpdf extends \Magento\Framework\App\Action\Action
{
    ...
    public function _downloadpdf($prod_id, $image_id, $images, $parent_images_id)
    {
        ...
        $resize_width       = $config->getValue(self::ResizeWidth);
        ...
        $download_url = $this->makeDownloadImage($prod_image_path, $new_prod_image, $resize_width, $resize_height, $image_id, $srcNew, $download_img_url, $parent_images_id_final, $resize_width_band, $resize_height_band, $isEnableBand);

        return $paths;
    }

    public function makeDownloadImage($prod_image_path, $new_prod_image, $resize_width, $resize_height, $image_id, $srcNew, $download_img_url, $parent_images_id_final, $resize_width_band, $resize_height_band, $isEnableBand = 0)
    {
