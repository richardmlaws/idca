        ...
        foreach ($merged_images as $key => $image) {
            foreach ($grouped_product_images as $product_image) {
                if ($product_image->getId() == $key) {
                    ...
                    ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA).'productdesigner/designs/catalog/product/base'.$design_images['base'].'" style="display: block;margin: auto;" />';
                }
            }
        }
    }
