...
class Collectband extends Action
{
        ...
        try {
            ...
            if ($watermarktext != '') {
                ...
                foreach ($splitText as $txt) {
                    ...
                    $textBox    = imagettfbbox(100, 30, $font, $txt);
                ...
                $prod_image_dir = $reader->getAbsolutePath() . 'productdesigner/uploadwatermark/';
                $image_path     = $prod_image_dir . 'default/textwatermarkband.png';
                ...
                $png           = $demo->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'productdesigner/uploadwatermark/default/textwatermarkband.png';
                $basedirpath   = $reader->getAbsolutePath() . 'productdesigner/uploadwatermark/default/textwatermarkband.png';
                ...
                $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
                $demo          = $objectManager->create('\Magento\Store\Model\StoreManagerInterface');
                $png1          = $demo->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'productdesigner/uploadwatermark/default/textwatermarkband.png';
                $image_path1   = $reader->getAbsolutePath() . 'productdesigner/uploadwatermark/default/textwatermarkband.png';
