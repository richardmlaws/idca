...
class Massdelete extends \Biztech\Productdesigner\Controller\Adminhtml\Designtemplatecategory {

    public function execute() {

        $id = $this->getRequest()->getParam('designtemplatecategory');
        ...
        if ($id) {
            try {
                ...
                $this->_redirect('productdesigner/designtemplatecategory/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
