...
class Image extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer {
    ...
    public function render(\Magento\Framework\DataObject $row) {
        ...
        $designImages = $objectManager->create('Biztech\Productdesigner\Model\Mysql4\Designtemplateimages\Collection')->addFieldToFilter('designtemplates_id', Array('eq' => $designtemplate_id))->addFieldToFilter('design_image_type', 'base')->getData();
