...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data && isset($data['tab_id']) && !isset($data['prod_id'])) {
                ...
                SET iptv1.value='{$data['label']}',iptvi2.value={$data['is_active']},iptvi4.value='{$data['content']}' , iptvi5.value={$data['show_purchased']} , iptvi6.value='{$data['group']}'
                    ...
                    foreach($attrStore as $atrS){
                        ...
                        if(!empty($explodes[1])){
                            ...
                            if(isset($data[$explodes[0]])) {
                                ...
                                $set = $set . " {$setAlias[$explodes[0]]}.value='{$data[$explodes[0]]}', ";
                            ...
                            if(isset($data[$explodes[0]])){
                                ...
                                if(in_array($setArrayField[$explodes[0]],$arrTable)){
                                    $attrAray[$setArrayField[$explodes[0]]]= $attrAray[$setArrayField[$explodes[0]]].", ({$data['tab_id']},{$data['store_id']}, {$setArrayJoin[$explodes[0]]},'{$data[$explodes[0]]}')";
                                }else{
                                    $arrTable[]=$setArrayField[$explodes[0]];
                                    $attrAray[$setArrayField[$explodes[0]]]="INSERT INTO `{$setArrayField[$explodes[0]]}` (`tab_id`, `store_id`, `attribute_id`,`value`) VALUES ({$data['tab_id']},{$data['store_id']}, {$setArrayJoin[$explodes[0]]},'{$data[$explodes[0]]}') ";
                                }
                            }
                        }
                    }
                    ...
                    if(!empty($explodes[1])){
                        ...
                        if(isset($data[$explodes[0]])){
                            ...
                            if(in_array($setArrayField[$explodes[0]],$arrTable)){
                                ...
                                $arrTable[]=$setArrayField[$explodes[0]];
                                $attrAray[$setArrayField[$explodes[0]]]="INSERT INTO `{$setArrayField[$explodes[0]]}` (`tab_id`, `product_id`, `attribute_id`,`value`) VALUES ({$data['tab_id']},{$data['prod_id']}, {$setArrayJoin[$explodes[0]]},'{$data[$explodes[0]]}') ";
                            }
                        }
                    }
                }
                ...
                if(!empty($explodes[1]) && !empty($explodes[2])){
                    ...
                    if(isset($data[$explodes[0]])){
                        ...
                        if(in_array($setArrayField[$explodes[0]],$arrTable)){
                            ...
                            $arrTable[]=$setArrayField[$explodes[0]];
                            $attrAray[$setArrayField[$explodes[0]]]="INSERT INTO `{$setArrayField[$explodes[0]]}` (`tab_id`, `store_id`,`product_id`, `attribute_id`,`value`) VALUES ({$data['tab_id']},{$data['store_id']},{$data['prod_id']},{$setArrayJoin[$explodes[0]]},'{$data[$explodes[0]]}') ";
                        }
                    }
                }
            }
        ...
        try{
            ...
            try{
                ...
                if(!isset($data['prod_id'])) {
                    if (isset($data['group']))
                        $data['group'] = implode(',', $data['group']);
                    $conn->query("INSERT INTO {$resource->getTableName('itoris_product_tabs_value_varchar')} (`tab_id`, `attribute_id`,`value`) VALUE({$tabs->getId()},1,'{$data['label']}')");
                    ...
                    $conn->query("INSERT INTO {$resource->getTableName('itoris_product_tabs_value_text')}  (`tab_id`, `attribute_id`,`value`) VALUE({$tabs->getId()},4,'{$data['content']}'),({$tabs->getId()},6,'{$data['group']}')");
                    ...
                    $conn->query("INSERT INTO {$resource->getTableName('itoris_product_tabs_value_varchar')} (`tab_id`, `attribute_id`,`product_id`,`value`) VALUE
                                                                             ({$tabs->getId()},1,{$data['prod_id']},'{$data['label']}')");
                   ...
                   ({$tabs->getId()},4,{$data['prod_id']},'{$data['content']}'),
                   ({$tabs->getId()},6,{$data['prod_id']},'{$data['group']}')");
                    ...
                    $conn->query("INSERT INTO {$resource->getTableName('itoris_product_tabs_value_varchar')} (`tab_id`, `attribute_id`,`product_id`,`store_id`,`value`) VALUE
                                           ({$tabs->getId()},1,{$data['prod_id']},{$data['store_id']},'{$data['label']}')");
                    ...
                    VALUE({$tabs->getId()},4,{$data['prod_id']},{$data['store_id']},'{$data['content']}'),
