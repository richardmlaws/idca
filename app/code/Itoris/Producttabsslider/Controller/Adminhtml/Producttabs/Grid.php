    ...
    public function execute()
    {
        ...
        if(!$this->getRequest()->getParam('id_product') && !$this->getRequest()->getParam('id_store')) {
            ...
            if ($this->getRequest()->getParam('down') && $this->getRequest()->getParam('this_sort')) {
                ...
                if(count($sortStore)==2){
                    /* $sql = "INSERT INTO  {$resource->getTableName('itoris_product_tabs_value_int')}  (tab_id,product_id,value,attribute_id) VALUES ({$this->getRequest()->getParam('id_down')},{$this->getRequest()->getParam('id_product')},{$this->getRequest()->getParam('this_sort')},3)";
                     ...
                     $conn->query($sql);
                     $conn->query($sql1);*/
                    $where="WHERE (tab_id={$this->getRequest()->getParam('id_down')} AND attribute_id=3 AND store_id={$this->getRequest()->getParam('id_store')}) AND store_id=NULL";
                    $where1= " WHERE (tab_id={$this->getRequest()->getParam('id_this')} AND attribute_id=3 AND store_id={$this->getRequest()->getParam('id_store')}) AND store_id=NULL";
            ...
            if ($this->getRequest()->getParam('up') && $this->getRequest()->getParam('this_sort')) {
                ...
                if (count($sortStore) == 2) {
                    /* $sql = "INSERT INTO  {$resource->getTableName('itoris_product_tabs_value_int')}  (tab_id,product_id,value,attribute_id) VALUES ({$this->getRequest()->getParam('id_down')},{$this->getRequest()->getParam('id_product')},{$this->getRequest()->getParam('this_sort')},3)";
                     ...
                     $conn->query($sql);
                     $conn->query($sql1);*/
                    $where = "WHERE (tab_id={$this->getRequest()->getParam('up')} AND attribute_id=3 AND store_id={$this->getRequest()->getParam('id_store')}) AND store_id=NULL";
                    $where1 = " WHERE (tab_id={$this->getRequest()->getParam('id_this')} AND attribute_id=3 AND store_id={$this->getRequest()->getParam('id_store')}) AND store_id=NULL";
            ...
            if ($this->getRequest()->getParam('down') && $this->getRequest()->getParam('this_sort')) {
                ...
                if(count($sortStore)==2){
                   /* $sql = "INSERT INTO  {$resource->getTableName('itoris_product_tabs_value_int')}  (tab_id,product_id,value,attribute_id) VALUES ({$this->getRequest()->getParam('id_down')},{$this->getRequest()->getParam('id_product')},{$this->getRequest()->getParam('this_sort')},3)";
                    ...
                    $conn->query($sql);
                    $conn->query($sql1);*/
                    $where="WHERE (tab_id={$this->getRequest()->getParam('id_down')} AND attribute_id=3 AND product_id={$this->getRequest()->getParam('id_product')}) AND store_id=NULL";
                    $where1= " WHERE (tab_id={$this->getRequest()->getParam('id_this')} AND attribute_id=3 AND product_id={$this->getRequest()->getParam('id_product')}) AND store_id=NULL";
            ...
            if ($this->getRequest()->getParam('up') && $this->getRequest()->getParam('this_sort')) {
                ...
                if (count($sortStore) == 2) {
                    /* $sql = "INSERT INTO  {$resource->getTableName('itoris_product_tabs_value_int')}  (tab_id,product_id,value,attribute_id) VALUES ({$this->getRequest()->getParam('id_down')},{$this->getRequest()->getParam('id_product')},{$this->getRequest()->getParam('this_sort')},3)";
                     ...
                     $conn->query($sql);
                     $conn->query($sql1);*/
                    $where = "WHERE (tab_id={$this->getRequest()->getParam('up')} AND attribute_id=3 AND product_id={$this->getRequest()->getParam('id_product')}) AND store_id=NULL";
                    $where1 = " WHERE (tab_id={$this->getRequest()->getParam('id_this')} AND attribute_id=3 AND product_id={$this->getRequest()->getParam('id_product')}) AND store_id=NULL";
            ...
            if ($this->getRequest()->getParam('down') && $this->getRequest()->getParam('this_sort')) {
                ...
                $conn = $resource->getConnection();
                $query = "SELECT * FROM (SELECT iptvi.tab_id as tab,iptvi.product_id as product,iptvi.store_id as store,iptvi.value as val  FROM {$resource->getTableName('itoris_product_tabs_value_int')} as iptvi WHERE (value_id={$this->getRequest()->getParam('thisValue')} OR value_id={$this->getRequest()->getParam('nextValue')})
                  AND   iptvi.attribute_id=3 HAVING 1 ORDER BY val ASC) as tt ";
                $sortStore = $conn->fetchAll($query);
                $resource = $this->_objectManager->create('Magento\Framework\App\ResourceConnection');
                if(count($sortStore)==2){
                    /* $sql = "INSERT INTO  {$resource->getTableName('itoris_product_tabs_value_int')}  (tab_id,product_id,value,attribute_id) VALUES ({$this->getRequest()->getParam('id_down')},{$this->getRequest()->getParam('id_product')},{$this->getRequest()->getParam('this_sort')},3)";
                     ...
                     $conn->query($sql);
                     $conn->query($sql1);*/
                    $where="WHERE (tab_id={$this->getRequest()->getParam('id_down')} AND attribute_id=3 AND store_id = {$this->getRequest()->getParam('store')} AND product_id={$this->getRequest()->getParam('id_product')})";
                    $where1= " WHERE (tab_id={$this->getRequest()->getParam('id_this')} AND attribute_id=3 AND store_id = {$this->getRequest()->getParam('store')}  AND product_id={$this->getRequest()->getParam('id_product')})";
            ...
            if ($this->getRequest()->getParam('up') && $this->getRequest()->getParam('this_sort')) {
                ...
                if (count($sortStore) == 2) {
                    /* $sql = "INSERT INTO  {$resource->getTableName('itoris_product_tabs_value_int')}  (tab_id,product_id,value,attribute_id) VALUES ({$this->getRequest()->getParam('id_down')},{$this->getRequest()->getParam('id_product')},{$this->getRequest()->getParam('this_sort')},3)";
                     ...
                     $conn->query($sql);
                     $conn->query($sql1);*/
                    $where = "WHERE (tab_id={$this->getRequest()->getParam('up')} AND attribute_id=3 AND store_id = {$this->getRequest()->getParam('id_store')} AND product_id={$this->getRequest()->getParam('id_product')})";
                    $where1 = " WHERE (tab_id={$this->getRequest()->getParam('id_this')} AND attribute_id=3 AND store_id = {$this->getRequest()->getParam('id_store')} AND product_id={$this->getRequest()->getParam('id_product')})";
                    if ($sortStore[0]['store'] == NULL && $sortStore[1]['store'] == NULL) {
