...
class Item extends \Magento\Quote\Model\Quote\Item {
    ...
    public function calcRowTotal() {
        ...
        if (!is_null($finalPrice)) {
            ...
            $this->setRowTotal($this->priceCurrency->round($finalPrice * $this->getQty()))
                ->setBaseRowTotal($this->priceCurrency->round($finalPrice * $this->getQty()));
    ...
    public function getRowTotal(){
        ...
        if (!is_null($finalPrice)) {
            ...
            return $this->priceCurrency->round($finalPrice * $this->getQty());
        }
